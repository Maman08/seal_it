...
import SignInForm from "../(auth)/signup/Signin";
import SignUpForm from "../(auth)/signup/Signup";
import ForgotPasswordDialog from "../(auth)/ForgetPassword";
...
export default function App() {
    ...
    useEffect(() => {
        onAuthStateChanged(auth, (user) => {
            if(user){
                if (userType === "Admin!") {
                    router.push(`/seal-it-admin`);
                }
                else if (userType === "User!") {
                    router.push(`/seal-it-user`);
                }
                else {
                    router.push(`/`);
                }
  ...
  return (
    <div className="App loginbody">
      ...
      <div className={`${containerClass} mx-auto`} id="container">
